...
from .lukas_kanade_tracking_fallback_and_nbjw_keypoints_regular_grid import track_homographies
#from .derp_check_nbjw_keypoints_regular_grid import track_homographies
#from .raft_tracking_fallback_and_nbjw_keypoints_regular_grid import track_homographies
...
class HTracker(VideoLevelModule):
    ...
    def process(self, detections: pd.DataFrame, metadatas: pd.DataFrame):
        ...
        if count < 1:
            ...
            debug_path = os.path.join(
                '/home/ziegler/MA/SoccerNet/sn-gamestate/sn_gamestate/homography_tracking/paper',
                unique_video_ids[0]
            )

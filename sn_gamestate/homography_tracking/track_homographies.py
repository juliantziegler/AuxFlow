...
from .lukas_kanade_tracking_fallback import track_homographies
            ...
            for i in range(count):
                ...
                if i == 0 and current_idx > 0:
                    ...
                    if len(back_track) > 1:
                        ...
                        back_homographies = track_homographies(initial_H, back_track, back_bboxes, -1, debug_back, back_homs)
                ...
                if i < count - 1:
                    ...
                    if gap <= 1:
                        ...
                        if len(forward_track) > 1:
                            ...
                            forward_homographies = track_homographies(initial_H, forward_track, forward_bboxes, 1, debug_forward, forward_homs)
